...
- **[crash-course.md](crash-course.md)** — Reference on patterns, tech stack, and vocabulary. Read for the "why" behind design choices.
- **[patterns.md](patterns.md)** — Cross-cutting patterns mapped back to specific exercises.
